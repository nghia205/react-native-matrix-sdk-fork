...
extern "C" {
    ...
    RustBuffer ffi_matrix_sdk_ui_rustbuffer_alloc(
        uint64_t size, 
        RustCallStatus *uniffi_out_err
    );
    RustBuffer ffi_matrix_sdk_ui_rustbuffer_from_bytes(
        ForeignBytes bytes, 
        RustCallStatus *uniffi_out_err
    );
    void ffi_matrix_sdk_ui_rustbuffer_free(
        RustBuffer buf, 
        RustCallStatus *uniffi_out_err
    );
    RustBuffer ffi_matrix_sdk_ui_rustbuffer_reserve(
        RustBuffer buf, 
        uint64_t additional, 
        RustCallStatus *uniffi_out_err
    );
    void ffi_matrix_sdk_ui_rust_future_poll_u8(
        /*handle*/ uint64_t handle, 
        UniffiRustFutureContinuationCallback callback, 
        /*handle*/ uint64_t callback_data
    );
    void ffi_matrix_sdk_ui_rust_future_cancel_u8(
        /*handle*/ uint64_t handle
    );
    void ffi_matrix_sdk_ui_rust_future_free_u8(
        /*handle*/ uint64_t handle
    );
    uint8_t ffi_matrix_sdk_ui_rust_future_complete_u8(
        /*handle*/ uint64_t handle, 
        RustCallStatus *uniffi_out_err
    );
    void ffi_matrix_sdk_ui_rust_future_poll_i8(
        /*handle*/ uint64_t handle, 
        UniffiRustFutureContinuationCallback callback, 
        /*handle*/ uint64_t callback_data
    );
    void ffi_matrix_sdk_ui_rust_future_cancel_i8(
        /*handle*/ uint64_t handle
    );
    void ffi_matrix_sdk_ui_rust_future_free_i8(
        /*handle*/ uint64_t handle
    );
    int8_t ffi_matrix_sdk_ui_rust_future_complete_i8(
        /*handle*/ uint64_t handle, 
        RustCallStatus *uniffi_out_err
    );
    void ffi_matrix_sdk_ui_rust_future_poll_u16(
        /*handle*/ uint64_t handle, 
        UniffiRustFutureContinuationCallback callback, 
        /*handle*/ uint64_t callback_data
    );
    void ffi_matrix_sdk_ui_rust_future_cancel_u16(
        /*handle*/ uint64_t handle
    );
    void ffi_matrix_sdk_ui_rust_future_free_u16(
        /*handle*/ uint64_t handle
    );
    uint16_t ffi_matrix_sdk_ui_rust_future_complete_u16(
        /*handle*/ uint64_t handle, 
        RustCallStatus *uniffi_out_err
    );
    void ffi_matrix_sdk_ui_rust_future_poll_i16(
        /*handle*/ uint64_t handle, 
        UniffiRustFutureContinuationCallback callback, 
        /*handle*/ uint64_t callback_data
    );
    void ffi_matrix_sdk_ui_rust_future_cancel_i16(
        /*handle*/ uint64_t handle
    );
    void ffi_matrix_sdk_ui_rust_future_free_i16(
        /*handle*/ uint64_t handle
    );
    int16_t ffi_matrix_sdk_ui_rust_future_complete_i16(
        /*handle*/ uint64_t handle, 
        RustCallStatus *uniffi_out_err
    );
    void ffi_matrix_sdk_ui_rust_future_poll_u32(
        /*handle*/ uint64_t handle, 
        UniffiRustFutureContinuationCallback callback, 
        /*handle*/ uint64_t callback_data
    );
    void ffi_matrix_sdk_ui_rust_future_cancel_u32(
        /*handle*/ uint64_t handle
    );
    void ffi_matrix_sdk_ui_rust_future_free_u32(
        /*handle*/ uint64_t handle
    );
    uint32_t ffi_matrix_sdk_ui_rust_future_complete_u32(
        /*handle*/ uint64_t handle, 
        RustCallStatus *uniffi_out_err
    );
    void ffi_matrix_sdk_ui_rust_future_poll_i32(
        /*handle*/ uint64_t handle, 
        UniffiRustFutureContinuationCallback callback, 
        /*handle*/ uint64_t callback_data
    );
    void ffi_matrix_sdk_ui_rust_future_cancel_i32(
        /*handle*/ uint64_t handle
    );
    void ffi_matrix_sdk_ui_rust_future_free_i32(
        /*handle*/ uint64_t handle
    );
    int32_t ffi_matrix_sdk_ui_rust_future_complete_i32(
        /*handle*/ uint64_t handle, 
        RustCallStatus *uniffi_out_err
    );
    void ffi_matrix_sdk_ui_rust_future_poll_u64(
        /*handle*/ uint64_t handle, 
        UniffiRustFutureContinuationCallback callback, 
        /*handle*/ uint64_t callback_data
    );
    void ffi_matrix_sdk_ui_rust_future_cancel_u64(
        /*handle*/ uint64_t handle
    );
    void ffi_matrix_sdk_ui_rust_future_free_u64(
        /*handle*/ uint64_t handle
    );
    uint64_t ffi_matrix_sdk_ui_rust_future_complete_u64(
        /*handle*/ uint64_t handle, 
        RustCallStatus *uniffi_out_err
    );
    void ffi_matrix_sdk_ui_rust_future_poll_i64(
        /*handle*/ uint64_t handle, 
        UniffiRustFutureContinuationCallback callback, 
        /*handle*/ uint64_t callback_data
    );
    void ffi_matrix_sdk_ui_rust_future_cancel_i64(
        /*handle*/ uint64_t handle
    );
    void ffi_matrix_sdk_ui_rust_future_free_i64(
        /*handle*/ uint64_t handle
    );
    int64_t ffi_matrix_sdk_ui_rust_future_complete_i64(
        /*handle*/ uint64_t handle, 
        RustCallStatus *uniffi_out_err
    );
    void ffi_matrix_sdk_ui_rust_future_poll_f32(
        /*handle*/ uint64_t handle, 
        UniffiRustFutureContinuationCallback callback, 
        /*handle*/ uint64_t callback_data
    );
    void ffi_matrix_sdk_ui_rust_future_cancel_f32(
        /*handle*/ uint64_t handle
    );
    void ffi_matrix_sdk_ui_rust_future_free_f32(
        /*handle*/ uint64_t handle
    );
    float ffi_matrix_sdk_ui_rust_future_complete_f32(
        /*handle*/ uint64_t handle, 
        RustCallStatus *uniffi_out_err
    );
    void ffi_matrix_sdk_ui_rust_future_poll_f64(
        /*handle*/ uint64_t handle, 
        UniffiRustFutureContinuationCallback callback, 
        /*handle*/ uint64_t callback_data
    );
    void ffi_matrix_sdk_ui_rust_future_cancel_f64(
        /*handle*/ uint64_t handle
    );
    void ffi_matrix_sdk_ui_rust_future_free_f64(
        /*handle*/ uint64_t handle
    );
    double ffi_matrix_sdk_ui_rust_future_complete_f64(
        /*handle*/ uint64_t handle, 
        RustCallStatus *uniffi_out_err
    );
    void ffi_matrix_sdk_ui_rust_future_poll_rust_buffer(
        /*handle*/ uint64_t handle, 
        UniffiRustFutureContinuationCallback callback, 
        /*handle*/ uint64_t callback_data
    );
    void ffi_matrix_sdk_ui_rust_future_cancel_rust_buffer(
        /*handle*/ uint64_t handle
    );
    void ffi_matrix_sdk_ui_rust_future_free_rust_buffer(
        /*handle*/ uint64_t handle
    );
    RustBuffer ffi_matrix_sdk_ui_rust_future_complete_rust_buffer(
        /*handle*/ uint64_t handle, 
        RustCallStatus *uniffi_out_err
    );
    void ffi_matrix_sdk_ui_rust_future_poll_void(
        /*handle*/ uint64_t handle, 
        UniffiRustFutureContinuationCallback callback, 
        /*handle*/ uint64_t callback_data
    );
    void ffi_matrix_sdk_ui_rust_future_cancel_void(
        /*handle*/ uint64_t handle
    );
    void ffi_matrix_sdk_ui_rust_future_free_void(
        /*handle*/ uint64_t handle
    );
    void ffi_matrix_sdk_ui_rust_future_complete_void(
        /*handle*/ uint64_t handle, 
        RustCallStatus *uniffi_out_err
    );
    uint32_t ffi_matrix_sdk_ui_uniffi_contract_version(
    );
}
...
template <typename T> struct Bridging<ReferenceHolder<T>> {
  ...
  static T fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    if (obj.hasProperty(rt, "pointee")) {
      ...
      return uniffi::matrix_sdk_ui::Bridging<T>::fromJs(rt, callInvoker, pointee);
    }
    throw jsi::JSError(
      rt,
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
      ...
      return ffi_matrix_sdk_ui_rustbuffer_alloc(
          size,
          &status
      );
  }
  ...
  static void rustbuffer_free(RustBuffer buf) {
    RustCallStatus status = { UNIFFI_CALL_STATUS_OK };
    ffi_matrix_sdk_ui_rustbuffer_free(
        buf,
        &status
    );
  }
  ...
  static RustBuffer rustbuffer_from_bytes(ForeignBytes bytes) {
    RustCallStatus status = { UNIFFI_CALL_STATUS_OK };
    return ffi_matrix_sdk_ui_rustbuffer_from_bytes(
      bytes,
      &status
    );
  }
...
namespace uniffi::matrix_sdk_ui::registry {
    template <typename T>
    class VTableHolder {
    public:
        T vtable;
...
// Callback function: uniffi::matrix_sdk_ui::cb::rustfuturecontinuationcallback::UniffiRustFutureContinuationCallback
//
...
// future.
namespace uniffi::matrix_sdk_ui::cb::rustfuturecontinuationcallback {
    using namespace facebook;
    ...
    makeCallbackFunction( // uniffi::matrix_sdk_ui::cb::rustfuturecontinuationcallback
                    jsi::Runtime &rt,
                     std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
                     const jsi::Value &value) {
        if (rsLambda != nullptr) {
    ...
    // This method is called from the destructor of NativeMatrixSdkUi, which only happens
...
// Callback function: uniffi::matrix_sdk_ui::cb::foreignfuturedroppedcallback::UniffiForeignFutureDroppedCallback
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
// We then give the `callback` function pointer to Rust which will call the lambda sometime in the
// future.
namespace uniffi::matrix_sdk_ui::cb::foreignfuturedroppedcallback {
    using namespace facebook;
    ...
    makeCallbackFunction( // uniffi::matrix_sdk_ui::cb::foreignfuturedroppedcallback
                    jsi::Runtime &rt,
                     std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
                     const jsi::Value &value) {
        if (rsLambda != nullptr) {
...
template <> struct Bridging<UniffiForeignFutureDroppedCallbackStruct> {
  static UniffiForeignFutureDroppedCallbackStruct fromJs(jsi::Runtime &rt,
    ...
    rsObject.free = uniffi::matrix_sdk_ui::cb::foreignfuturedroppedcallback::makeCallbackFunction(
...
template <> struct Bridging<UniffiForeignFutureResultU8> {
  static UniffiForeignFutureResultU8 fromJs(jsi::Runtime &rt,
    ...
    rsObject.call_status = uniffi::matrix_sdk_ui::Bridging<RustCallStatus>::fromJs(
        rt, callInvoker,
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(
    ...
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureResultU8>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteI8> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureResultI8>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteU16> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureResultU16>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteI16> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureResultI16>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteU32> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureResultU32>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteI32> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureResultI32>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteU64> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureResultU64>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteI64> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureResultI64>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteF32> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureResultF32>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteF64> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureResultF64>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureResultRustBuffer> {
  static UniffiForeignFutureResultRustBuffer fromJs(jsi::Runtime &rt,
    ...
    // Create the vtable from the js callbacks.
    rsObject.return_value = uniffi::matrix_sdk_ui::Bridging<RustBuffer>::fromJs(
        rt, callInvoker,
        jsObject.getProperty(rt, "returnValue")
      );
    rsObject.call_status = uniffi::matrix_sdk_ui::Bridging<RustCallStatus>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteRustBuffer> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureResultRustBuffer>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiForeignFutureCompleteVoid> {
  ...
  static jsi::Value intoRust(
    ...
    // Convert the arguments into the Rust, with Bridging<T>::fromJs,
    // then call the rs_callback with those arguments.
        func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]), uniffi::matrix_sdk_ui::Bridging<UniffiForeignFutureResultVoid>::fromJs(rt, callInvoker, args[1])
        );
...
template <> struct Bridging<UniffiRustFutureContinuationCallback> {
  static UniffiRustFutureContinuationCallback fromJs(
    ...
    try {
      return uniffi::matrix_sdk_ui::cb::rustfuturecontinuationcallback::makeCallbackFunction(
        rt,
        callInvoker,
        value
      );
...
NativeMatrixSdkUi::NativeMatrixSdkUi(
    jsi::Runtime &rt,
    ...
    props["ubrn_ffi_matrix_sdk_ui_uniffi_contract_version"] = jsi::Function::createFromHostFunction(
        rt,
        jsi::PropNameID::forAscii(rt, "ubrn_ffi_matrix_sdk_ui_uniffi_contract_version"),
        0,
        [this](jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_ffi_matrix_sdk_ui_uniffi_contract_version(rt, thisVal, args, count);
        }
    );
}

void NativeMatrixSdkUi::registerModule(jsi::Runtime &rt, std::shared_ptr<react::CallInvoker> callInvoker) {
    auto invoker = std::make_shared<uniffi_runtime::UniffiCallInvoker>(callInvoker);
    auto tm = std::make_shared<NativeMatrixSdkUi>(rt, invoker);
    auto obj = rt.global().createFromHostObject(rt, tm);
    rt.global().setProperty(rt, "NativeMatrixSdkUi", obj);
}

void NativeMatrixSdkUi::unregisterModule(jsi::Runtime &rt) {
    uniffi::matrix_sdk_ui::registry::clearRegistry();
}

jsi::Value NativeMatrixSdkUi::get(jsi::Runtime& rt, const jsi::PropNameID& name) {
    try {
...
std::vector<jsi::PropNameID> NativeMatrixSdkUi::getPropertyNames(jsi::Runtime& rt) {
...
void NativeMatrixSdkUi::set(jsi::Runtime& rt, const jsi::PropNameID& name, const jsi::Value& value) {
    props.insert_or_assign(name.utf8(rt), &value);
}

NativeMatrixSdkUi::~NativeMatrixSdkUi() {
    // Cleanup for callback function RustFutureContinuationCallback
uniffi::matrix_sdk_ui::cb::rustfuturecontinuationcallback::cleanup();
    // Cleanup for callback function ForeignFutureDroppedCallback
uniffi::matrix_sdk_ui::cb::foreignfuturedroppedcallback::cleanup();
    // Cleanup for "free" callback function CallbackInterfaceFree

}

// Utility functions for serialization/deserialization of strings.
jsi::Value NativeMatrixSdkUi::cpp_uniffi_internal_fn_func_ffi__string_to_byte_length(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count) {
    return uniffi_jsi::Bridging<std::string>::string_to_bytelength(rt, args[0]);
}

jsi::Value NativeMatrixSdkUi::cpp_uniffi_internal_fn_func_ffi__string_to_arraybuffer(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count) {
    return uniffi_jsi::Bridging<std::string>::string_to_arraybuffer(rt, args[0]);
}

jsi::Value NativeMatrixSdkUi::cpp_uniffi_internal_fn_func_ffi__arraybuffer_to_string(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count) {
    return uniffi_jsi::Bridging<std::string>::arraybuffer_to_string(rt, args[0]);
}

// Methods calling directly into the uniffi generated C API of the Rust crate.
jsi::Value NativeMatrixSdkUi::cpp_ffi_matrix_sdk_ui_uniffi_contract_version(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count) {
        auto value = ffi_matrix_sdk_ui_uniffi_contract_version(
        );
